...
class protoParser {
    ...
    */
    getMagic() { return this.protoData.Magic; }
    getVersion() { return this.protoData.Version; }
    getRecords() { return this.protoData.Records; }
    gettotalCredit() { return this.protoData.totalCredit; }
    gettotalDebit() { return this.protoData.totalDebit; }
    getautopayStarts() { return this.protoData.autopayStarts; }
    getautopayEnds() { return this.protoData.autopayEnds; }
    getfsCurLoc() { return this.protoData.fsCurLoc; }
    setfsCurLoc(curloc) { return this.protoData.fsCurLoc = curloc; }
    setMagic(magic) { return this.protoData.Magic = magic; }
    setVersion(version) { return this.protoData.Version = version; }
    setRecords(records) { return this.protoData.Records = records; }
    settotalCredit(totalCredit) { return this.protoData.totalCredit = totalCredit; }
    settotalDebit(totalDebit) { return this.protoData.totalDebit = totalDebit; }
    setautopayStarts(starts) { return this.protoData.autopayStarts = starts; }
    setautopayEnds(ends) { return this.protoData.autopayEnds = ends; }

    /* 
      Loads the binary file into a buffer for processing
    */
    async loadFile () {
        try{
